    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-8 font-semibold text-slate-600">
            ...
            <?php elseif ($role == "admin"): ?>
                ...
                <a href="/books" class="hover:text-indigo-600 transition">Livres</a>
                <a href="/users" class="hover:text-indigo-600 transition">Utilisateurs</a>
                <a href="/emprunts" class="hover:text-indigo-600 transition">Emprunts</a>
            <?php endif; ?>
        </div>
        ...
        <div class="flex items-center space-x-4">
            <?php if ($role == "visitor"): ?>
                ...
                <a href="/create_account"
                    class="bg-indigo-600 text-white px-6 py-2.5 rounded-xl font-bold shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition transform hover:-translate-y-0.5">
                    Join Now
                </a>
            <?php else: ?>
                <div class="flex items-center gap-3 pl-4 border-l border-slate-200">
                    ...
                    <a href="/profile"
                        class="w-10 h-10 bg-indigo-100 border border-indigo-200 rounded-full flex items-center justify-center text-indigo-700 font-bold hover:bg-indigo-200 transition">
                        <?php echo strtoupper($_SESSION['user']->firstName[0].$_SESSION['user']->lastName[0] ?? 'U'); ?>
                    </a>
